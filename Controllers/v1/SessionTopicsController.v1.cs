...
{
    [Route("api/v1/sessions/{sessionId:int}/topics")]
    public class SessionTopicsControllerV1 : Controller
    {
        ...
        public SessionTopicsControllerV1(ISessionRepositoryV1 sessionRepository, ITeamsService teamsService,

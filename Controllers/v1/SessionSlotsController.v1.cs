...
{
    [Route("api/v1/sessions/{sessionId:int}/slots")]
    public class SessionSlotsControllerV1 : Controller
    {
        ...
        public SessionSlotsControllerV1(ISessionRepositoryV1 sessionRepository, IHubContext<SessionsHub, ISessionsHub> sessionsHub)
        {

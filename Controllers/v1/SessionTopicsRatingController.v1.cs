...
{
    [Route("api/v1/sessions/{sessionId:int}/topics/{topicId}/ratings")]
    public class SessionTopicsRatingControllerV1 : Controller
    {
        ...
        public SessionTopicsRatingControllerV1(ISessionRepositoryV1 sessionRepository, IHubContext<SessionsHub, ISessionsHub> sessionsHub)
        {

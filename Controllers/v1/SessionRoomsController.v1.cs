...
{
    [Route("api/v1/sessions/{sessionId:int}/rooms")]
    public class SessionRoomsControllerV1 : Controller
    {
        ...
        public SessionRoomsControllerV1(ISessionRepositoryV1 sessionRepository, IHubContext<SessionsHub, ISessionsHub> sessionsHub)
        {

...
namespace openspace.Controllers
{
    ...
    public class SessionsControllerV1 : Controller
    {
        private readonly ISessionRepositoryV1 _sessionRepository;
        private readonly ICalendarServiceV1 _calendarService;
        private readonly IHubContext<SessionsHub, ISessionsHub> _sessionsHub;

        public SessionsControllerV1(ISessionRepositoryV1 sessionRepository, ICalendarServiceV1 calendarService, IHubContext<SessionsHub, ISessionsHub> sessionsHub)
        {

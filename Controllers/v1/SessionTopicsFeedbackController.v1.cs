...
{
    [Route("api/v1/sessions/{sessionId:int}/topics/{topicId}/feedback")]
    public class SessionTopicsFeedbackControllerV1 : Controller
    {
        ...
        public SessionTopicsFeedbackControllerV1(ISessionRepositoryV1 sessionRepository, IHubContext<SessionsHub, ISessionsHub> sessionsHub)
        {

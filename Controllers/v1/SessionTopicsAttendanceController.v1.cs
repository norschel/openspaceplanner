...
{
    [Route("api/v1/sessions/{sessionId:int}/topics/{topicId}/attendances")]
    public class SessionTopicsAttendanceControllerV1 : Controller
    {
        private readonly ISessionRepositoryV1 _sessionRepository;
        private readonly IHubContext<SessionsHub, ISessionsHub> _sessionsHub;

        public SessionTopicsAttendanceControllerV1(ISessionRepositoryV1 sessionRepository, IHubContext<SessionsHub, ISessionsHub> sessionsHub)
        {

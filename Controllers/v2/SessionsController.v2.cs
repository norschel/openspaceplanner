...
namespace openspace.Controllers
{
    ...
    public class SessionsControllerV2 : Controller
    {
        private readonly ISessionRepositoryV2 _sessionRepository;
        private readonly ICalendarServiceV2 _calendarService;
        private readonly IHubContext<SessionsHub, ISessionsHub> _sessionsHub;

        public SessionsControllerV2(ISessionRepositoryV2 sessionRepository, ICalendarServiceV2 calendarService, IHubContext<SessionsHub, ISessionsHub> sessionsHub)
        {

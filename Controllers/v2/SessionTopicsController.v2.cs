...
{
    [Route("api/v2/sessions/{sessionId:int}/topics")]
    public class SessionTopicsControllerV2 : Controller
    {
        ...
        public SessionTopicsControllerV2(ISessionRepositoryV2 sessionRepository, ITeamsService teamsService,

...
{
    [Route("api/v2/sessions/{sessionId:int}/topics/{topicId}/feedback")]
    public class SessionTopicsFeedbackControllerV2 : Controller
    {
        ...
        public SessionTopicsFeedbackControllerV2(ISessionRepositoryV2 sessionRepository, IHubContext<SessionsHub, ISessionsHub> sessionsHub)
        {

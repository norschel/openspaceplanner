...
{
    [Route("api/v2/sessions/{sessionId:int}/topics/{topicId}/attendances")]
    public class SessionTopicsAttendanceControllerV2 : Controller
    {
        private readonly ISessionRepositoryV2 _sessionRepository;
        private readonly IHubContext<SessionsHub, ISessionsHub> _sessionsHub;

        public SessionTopicsAttendanceControllerV2(ISessionRepositoryV2 sessionRepository, IHubContext<SessionsHub, ISessionsHub> sessionsHub)
        {

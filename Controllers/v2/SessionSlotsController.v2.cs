...
{
    [Route("api/v2/sessions/{sessionId:int}/slots")]
    public class SessionSlotsControllerV2 : Controller
    {
        ...
        public SessionSlotsControllerV2(ISessionRepositoryV2 sessionRepository, IHubContext<SessionsHub, ISessionsHub> sessionsHub)
        {

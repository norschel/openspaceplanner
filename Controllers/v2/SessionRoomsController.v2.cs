...
{
    [Route("api/v2/sessions/{sessionId:int}/rooms")]
    public class SessionRoomsControllerV2 : Controller
    {
        ...
        public SessionRoomsControllerV2(ISessionRepositoryV2 sessionRepository, IHubContext<SessionsHub, ISessionsHub> sessionsHub)
        {

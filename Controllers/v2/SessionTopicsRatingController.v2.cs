...
{
    [Route("api/v2/sessions/{sessionId:int}/topics/{topicId}/ratings")]
    public class SessionTopicsRatingControllerV2 : Controller
    {
        ...
        public SessionTopicsRatingControllerV2(ISessionRepositoryV2 sessionRepository, IHubContext<SessionsHub, ISessionsHub> sessionsHub)
        {

...
{
    public class CalendarServiceV2 : ICalendarServiceV2
    {
        private readonly ISessionRepositoryV2 _sessionRepository;
        private readonly DateTimeZone _timezone;

        public CalendarServiceV2(ISessionRepositoryV2 sessionRepository, string timezone)
        {
        ...
        private async Task<bool> BuildSessionAsync(StringBuilder sb, int id)
        {
            ...
            var dateMatch = Regex.Match(session.DisplayName, "(\\d+\\.\\d+.\\d+)");

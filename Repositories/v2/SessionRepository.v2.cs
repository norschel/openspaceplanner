...
{
    public class SessionRepositoryV2 : ISessionRepositoryV2
    {
        ...
        public SessionRepositoryV2(IConfiguration configuration)
        {
        ...
        public async Task<Session> Create()
        {
            ...
            lock (_sessions)
            {
                ...
                session.DisplayName = "Session #" + session.Id;
